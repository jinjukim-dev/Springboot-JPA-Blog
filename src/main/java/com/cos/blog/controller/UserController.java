...
public class UserController {
	...
	public String kakaoCallback(String code) { // Data를 리턴해주는 컨트롤러 함수
		...
		params.add("client_id", "f76c17f08663bbe02bf6738e05a7d0ce");
		...
		ResponseEntity<String> response2 = rt2.exchange(
					"https://kapi.kakao.com/v2/user/me", // 토큰 요청 발급 주소
					HttpMethod.POST,
		...
		System.out.println("블로그 페스워드 : "+ cosKey);
